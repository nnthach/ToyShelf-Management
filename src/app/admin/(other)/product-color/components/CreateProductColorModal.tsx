...
function CreateProductColorModal() {
  const formSchema = z.object({
    fullname: z.string("").min(1, "Tên màu sắc sản phẩm là bắt buộc"),
    adminOfStore: z.string("").min(1, "Tên quản trị cửa hàng là bắt buộc"),
    partnerLevel: z.string("").min(1, "Cấp bậc đối tác là bắt buộc"),
  });
      ...
      <form>
        <DialogTrigger asChild>
          <Button className="btn-primary-gradient">
            <Plus /> Tạo màu sắc sản phẩm
          </Button>
        </DialogTrigger>
        <DialogContent className="sm:max-w-[425px]">
          <DialogHeader>
            <DialogTitle>Tạo màu sắc sản phẩm</DialogTitle>
            <DialogDescription>
          ...
          <FormProvider {...form}>
            ...
            >
              ...
              <FormFieldCustom
                name="adminOfStore"
                label="Tên quản trị cửa hàng"
                placeholder="Tên quản trị cửa hàng"
                type="select"
                selectData={partnerLevelOption}
              />
            </form>
