...
function ViewEverydayReportSheet({ children }: { children: React.ReactNode }) {
        ...
        <SheetContent className="w-full !max-w-[800px]">
          <SheetHeader className="pb-0">
            <SheetTitle className="">
              <h1 className="text-xl">Các báo cáo hàng ngày</h1>
            </SheetTitle>
          </SheetHeader>
              ...
              <div className="mt-4 border rounded-xl bg-background overflow-hidden">
                ...
                <div className="border-b px-4 py-3">
                  <p className="font-semibold">
                    Báo cáo <span className="text-gray-500">(9)</span>
                  </p>
...
export default ViewEverydayReportSheet;
