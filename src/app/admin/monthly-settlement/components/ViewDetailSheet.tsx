import { MonthlySettlement, User } from "@/src/types";
  ...
  return (
    <Sheet>
      ...
      <SheetContent className="w-full !max-w-[1200px]">
        <SheetHeader>
          <SheetTitle>Thông tin thanh toán hoa hồng đối tác</SheetTitle>
          <SheetDescription>
            Thông tin về đối tác {monthlySettlement.partnerName}
          </SheetDescription>
        </SheetHeader>
