...
import ConfirmPaymentWithImg from "../components/ConfirmPaymentWithImg";
        ...
        <section className="space-y-6">
          ...
          <div className="flex flex-wrap items-center justify-between gap-6 bg-white dark:bg-slate-900/50 p-4 rounded-3xl border border-slate-200/60 shadow-sm">
            ...
            <div className="flex items-center gap-3 min-w-[300px]">
              {monthlyDetail?.status === "PENDING" && (
                <Button
                  variant="success"
                  onClick={() => handleFinalize(monthlyDetail.id)}
                  className="w-full h-10 font-bold rounded-2xl shadow-sm shadow-green-200 dark:shadow-none"
                >
              ...
              {monthlyDetail?.status === "FINALIZED" && (
                <>
                  <Button
                    variant="outline"
                    onClick={() => setIsOpenDeduction(true)}
                    className="flex-1 h-10 font-bold rounded-2xl border-slate-200 hover:bg-slate-100"
                  >
                  ...
                  <Button
                    ...
                    className="flex-[1.5] h-10 font-bold rounded-2xl shadow-sm shadow-green-200 dark:shadow-none"
                  >
                    <CheckCircle2 size={20} strokeWidth={2.5} />
                    Xác nhận thanh toán
                  </Button>
