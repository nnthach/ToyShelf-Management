...
function UpdateShelfTypeModal({ shelfTypeId }: { shelfTypeId: string }) {
  ...
  const form = useForm<UpdateShelfFormValues>({
  ...
  const validateSubLevelCateType = (data: UpdateShelfFormValues) => {
  ...
  // submit form
  async function onSubmit(data: UpdateShelfFormValues) {
  ...
  return (
    ...
    >
      ...
      <DialogContent className="sm:max-w-[600px] p-0 overflow-hidden border-none shadow-2xl">
        ...
        {isLoading ? (
          <div className=" bg-white/70 h-[70px] flex items-center justify-center z-50">
