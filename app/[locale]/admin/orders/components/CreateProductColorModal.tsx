...
function CreateProductColorModal() {
  ...
  const tCreateProductColor = useTranslations(
    "admin.productColor.createProductColor"
  );
      ...
      <form>
        <DialogTrigger asChild>
          <Button className="btn-primary-gradient">
            <Plus /> {tCreateProductColor("header")}
          </Button>
        </DialogTrigger>
        <DialogContent className="sm:max-w-[425px]">
          <DialogHeader>
            <DialogTitle>{tCreateProductColor("header")}</DialogTitle>
            <DialogDescription>
