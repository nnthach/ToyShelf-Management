...
function CreatePartnerLevelModal() {
  ...
  const tCreateProductCategory = useTranslations(
    "admin.partnerLevel.createPartnerLevel",
  );
      ...
      <form>
        <DialogTrigger asChild>
          <Button className="btn-primary-gradient">
            <Plus /> {tCreateProductCategory("header")}
          </Button>
        </DialogTrigger>
        <DialogContent className="sm:max-w-[425px]">
          <DialogHeader>
            <DialogTitle>{tCreateProductCategory("header")}</DialogTitle>
            <DialogDescription>
